                            ...
                            <div class="body">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line {{ $errors->has('categories') ? 'focused error' : '' }}">
                                            ...
                                            <!-- <select name="categories[]" id="category" class="form-control show-tick" multiple="multiple" data-live-search="true">
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            ...
                            <div class="body">
                                <textarea name="body" id="tinymce" cols="" rows="">{{$post->body}}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
...
@push('js')
    <!-- Select Plugin Js -->
    <script src="{{ asset('assets/backend/plugins/bootstrap-
    select/js/bootstrap-select.js') }}"></script>
    <!-- TinyMCE -->
